...
function ChangeProfile() {
    ...
    if (firstname.style.display === 'none') {
        btn_div.innerHTML = " <button type=\"submit\"  class=\"edit_profile_btn\" title=\"Back to your profile\" style=\"color: red \"><i class=\"fa fa-backward\"></i>Back</button><button class=\"save_profile_btn\" title = \"Save all your changes\" > <i class=\"fa fa-save\"></i><strong>Save</strong></button > ";
