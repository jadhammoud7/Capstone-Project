...
<head>
    ...
    <title>Admin | Add or Edit Product - Newbies Gamers</title>
</head>
                ...
                <div class="details">
                    <div class="card">
                        ...
                        <div class="form-container card-body">
                            <form action="add-edit-product.php" method="POST">
                                    ...
                                    <div class="form-container-part-inputs">
                                        <div class="input-container description">
                                            <div class="description-body">
                                                <h3>Description</h3>
                                                <p>
                                                    <textarea name="description" id="description" cols="120" rows="5" placeholder="Write a brief description or information related to this product" value=""></textarea>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="product-details-buttons">
                                    <button class="add-new-product" type="submit" title="Add new product">
                                        <span class="las la-plus-circle" style="font-size: 1.4rem;"></span>
                                        Add Product</button>
                                </div>
                            </form>
                        </div>
