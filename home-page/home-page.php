...
<body onunload="myFunction()">
    ...
    <div class="about-us">
        <div class="about-us-paragraph">
            ...
            <a href="../aboutus/about-us.html" class="about-us-button"
    ...
    <div>
        ...
        <div class="appointments">
            <div class="appointments-paragraph">
                ...
                <a href="../appointments/appointments.html" class="appointments-button"
        ...
        <div class="contact-us">
            ...
            <div class="contact_us_paragraphs">
                ...
                <a href="../contactus/contactus.html" class="contact-us-button"
                ...
                <li>
                    <div>
                        <ol class="footer-list-element">
                            ...
                            <li>
                                <a href="../home-page/home-page.html#features"
                            ...
                            <li>
                                <a href="../home-page/home-page.html#shop-products"
